...
/* package haskell-browser-0.1.0.0 */
#define VERSION_haskell_browser "0.1.0.0"
#define MIN_VERSION_haskell_browser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-browser-0.1.0.0-Dvl9RygyYHV3I0OeDiMOcq"

#define CURRENT_PACKAGE_KEY "haskell-browser-0.1.0.0-Dvl9RygyYHV3I0OeDiMOcq"
